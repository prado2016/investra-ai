-- Quick setup script for fund_movements table
...
DROP TRIGGER IF EXISTS trigger_update_fund_movements_updated_at ON fund_movements;
...
DROP POLICY IF EXISTS "Users can view their own fund movements" ON fund_movements;
DROP POLICY IF EXISTS "Users can create fund movements for their portfolios" ON fund_movements;
DROP POLICY IF EXISTS "Users can update their own fund movements" ON fund_movements;
DROP POLICY IF EXISTS "Users can delete their own fund movements" ON fund_movements;
